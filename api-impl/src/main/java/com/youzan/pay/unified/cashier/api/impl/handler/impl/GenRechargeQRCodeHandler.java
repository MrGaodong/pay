...
/**
 * @author twb
 * @version GenRechargeQRCodeHandler.java, v 0.1 2017-06-16 11:41
 */
@Component
@Slf4j
public class GenRechargeQRCodeHandler extends AbstractHandler<GenRechargeQRCodeRequest, QRCodeInfoResult> {

  @Resource
  private CacheService cacheService;

  @Override
  protected QRCodeInfoResult execute(GenRechargeQRCodeRequest request) throws Exception {
  ...
  private QRCodeInfo contractQRCodeInfo(GenRechargeQRCodeRequest request) {
    ...
    info.setCardNo(request.getCardNo());
    info.setRechargePayType(request.getRechargePayType());
...
//    String sign = SignService.sign(data, Constant.signKey, Constant.signType);
    ...
    String url = Constant.RECHARGE_URL_PREFIX + "?" +
                 "imageNo=" + key + "&" +
